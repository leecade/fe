...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _koa=__webpack_require__(25);var _koa2=_interopRequireDefault(_koa);var _koaBodyparser=__webpack_require__(26);var _koaBodyparser2=_interopRequireDefault(_koaBodyparser);var _koaJsonp=__webpack_require__(27);var _koaJsonp2=_interopRequireDefault(_koaJsonp);var _kcors=__webpack_require__(24);var _kcors2=_interopRequireDefault(_kcors);var _koaLogger=__webpack_require__(28);var _koaLogger2=_interopRequireDefault(_koaLogger);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var app=new _koa2.default();// import cors from 'koa-cors'
app.proxy=true;app.use((0,_koaLogger2.default)());// TODO: wait for this: https://github.com/koajs/cors/pull/20
app.use(function(ctx,next){ctx.set('Access-Control-Allow-Origin','*');ctx.set('Access-Control-Allow-Methods','GET,HEAD,PUT,POST,DELETE');ctx.set('Access-Control-Allow-Credentials','true');return next();});app.use((0,_kcors2.default)({origin:'*'}));app.use((0,_koaJsonp2.default)());app.use((0,_koaBodyparser2.default)({onerror:function onerror(err,ctx){console.log(err);ctx.throw('body parse error',422);}}));exports.default=app;
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _path=__webpack_require__(2);var _path2=_interopRequireDefault(_path);var _commander=__webpack_require__(20);var _commander2=_interopRequireDefault(_commander);var _chalk=__webpack_require__(1);var _chalk2=_interopRequireDefault(_chalk);var _utils=__webpack_require__(0);var _package=__webpack_require__(18);var _package2=_interopRequireDefault(_package);var _dev=__webpack_require__(10);var _dev2=_interopRequireDefault(_dev);var _build=__webpack_require__(8);var _build2=_interopRequireDefault(_build);var _init=__webpack_require__(12);var _init2=_interopRequireDefault(_init);var _list=__webpack_require__(13);var _list2=_interopRequireDefault(_list);var _generate=__webpack_require__(11);var _generate2=_interopRequireDefault(_generate);var _deploy=__webpack_require__(9);var _deploy2=_interopRequireDefault(_deploy);var _update=__webpack_require__(14);var _update2=_interopRequireDefault(_update);var _upgrade=__webpack_require__(15);var _upgrade2=_interopRequireDefault(_upgrade);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var cwdPath=_path2.default.resolve('.');// var program = require('commander')
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _path=__webpack_require__(2);var _path2=_interopRequireDefault(_path);var _webpack=__webpack_require__(33);var _webpack2=_interopRequireDefault(_webpack);var _chalk=__webpack_require__(1);var _chalk2=_interopRequireDefault(_chalk);var _utils=__webpack_require__(0);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){return step("next",value);},function(err){return step("throw",err);});}}return step("next");});};}var spinner=new _utils.Spinner();exports.default=function(){var _ref=_asyncToGenerator(regeneratorRuntime.mark(function _callee(cmd){var cwd,compiler;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:cwd=cmd.opts.projectRootPath;// Grab the webpack config, from:
...
},function(err,stats){err?_utils.log.error(err):_utils.log.success('Built successed!');});case 7:case'end':return _context.stop();}}},_callee,undefined);}));return function(_x){return _ref.apply(this,arguments);};}();
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.default=function(cmd){console.log('deploy');};
 ...
 */var PORT=3001;var Server=function(){function Server(cwd,mockPath){_classCallCheck(this,Server);this.listenerManager=null;this.mockPath=mockPath;this.cwd=cwd;}Server.prototype.restart=function restart(){delete __webpack_require__.c[/*require.resolve*/(3)];delete __webpack_require__.c[/*require.resolve*/(4)];/* Object.keys(require.cache).forEach(modulePath => {
    ...
    })*/this.stop();this.start();};Server.prototype.start=function start(cb){var _this=this;var devServer=__webpack_require__(3).default;var mockServer=__webpack_require__(4).default;devServer.context.cwd=this.cwd;mockServer(devServer);var server=devServer.listen(PORT,function(){cb&&cb.call(_this);// console.log(`Server started on ${PORT}`)
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.default=function(cmd){console.log('generate');};
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.default=function(cmd){console.log('init');};
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _updtr=__webpack_require__(32);exports.default=function(cmd){return(0,_updtr.run)({cwd:cmd.opts.projectRootPath,reporter:_updtr.reporters.default// wanted: commander.wanted,
...
});return mockPaths.map(function(item){var result=[];try{result=require(path.join(mockPath,item));}catch(err){console.log(err);}return result;});};
...
"use strict";
'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.mockServer=exports.devServer=undefined;var _devServer2=__webpack_require__(3);var _devServer3=_interopRequireDefault(_devServer2);var _mockServer2=__webpack_require__(4);var _mockServer3=_interopRequireDefault(_mockServer2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.devServer=_devServer3.default;exports.mockServer=_mockServer3.default;
